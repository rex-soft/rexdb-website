...
<div class="container" >
	<div class="lead">
		...
		<div style="margin-top: 50px; text-align:center"><a href="http://dl.rex-soft.org/rexdb/rexdb-1.0.2.zip" class="btn-lg btn-primary btn-outline main-btn">下载最新版本 （rexdb-1.0.2）</a></div>
	</div>
</div>
</section>
<div class="container">
